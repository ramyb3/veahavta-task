...
export default function AboutTheClinic({ data }: HomePageType) {
  return (<section id="about-us" className="bg-brown-bg">
    <WrapperLarge className="lg:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <Button
          className={'text-lg font-bold bg-icon-bg text-light px-8 py-2 rounded-full'}
