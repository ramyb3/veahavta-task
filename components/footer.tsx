  ...
  return (<WrapperLarge>
    <footer className="bg-light gap-6 grid md:grid-cols-2 lg:grid-cols-4 ">
      ...
      <div className="grid md:justify-self-center grid-rows-auto-1fr gap-2.5">
        <Button
          className={'text-icon-bg font-bold px-8 py-2 rounded-full border-2 border-solid'}
          text={data.footerScheduleButton}
        />
        <Button
          className={'text-icon-bg font-bold px-8 py-2 rounded-full border-2 border-solid h-[48px]'}
      ...
      <div>
        ...
        <ul className="grid gap-2 pt-2">
          ...
          <li>
            <a href={`mailto:${data.contactUsLinks[3].linkValue}`} target="_blank">
          ...
          <li>
            <a href={`https://www.google.co.il/maps/search/${data.contactUsLinks[2].linkValue}`} target="_blank">
              <div className='flex gap-2 mb-1'>
